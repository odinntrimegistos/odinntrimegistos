    ...
    programs: [
      {
        ...
        duration: "1 sessão",
        price: 180,
        description: "Confusão é mistura de substâncias. Isolamos o fato da emoção e o real da paranoia. Você sai com a mente filtrada e a visão limpa para o próximo passo.",
        ctaLabel: "AGENDAR",
      ...
      },
      {
        ...
        price: 333,
        priceLabel: "/ mês",
        description: "Estabilize o progresso. Encontros quinzenais para garantir que novos hábitos e insights se solidifiquem, impedindo a regressão aos velhos padrões. Manutenção da psique.",
      ...
      },
      {
        ...
        price: 630,
        priceLabel: "/ mês",
        description: "Protocolo de Alta Intensidade para crises ou luto. Usamos o 'fogo alto' semanal para acelerar a morte do velho eu. O único caminho para transmutar chumbo em ouro rapidamente.",
        ctaLabel: "INICIAR CICLO",
    ...
    services: [
      {
        ...
        price: 81,
        description:
          "Sem tempo para rodeios. Uma leitura direta para identificar o vetor de força que atua a seu favor ou contra você agora. A resposta tática para uma dúvida urgente.",
      ...
      },
      {
        ...
        price: 207,
        description:
          "Análise de Passado, Presente e Tendência. Se o futuro provável não agrada, desenhamos a estratégia para alterar a rota antes do impacto.",
        link: "https://wa.me/p/26011267368469521/5521996102492",
      },
      {
        name: "ANÁLISE DE CAMINHOS",
        price: 270,
        description:
          "Paralisia por análise? Colocamos suas opções na mesa (A ou B). Analiso o 'Preço' e o 'Prêmio' de cada caminho. Escolha sabendo o custo real e onde está o ouro.",
      ...
      },
      {
        ...
        price: 270,
        description:
          "Sua vida é um disco riscado? O problema é um padrão inconsciente. Escavamos sua sombra para identificar o vício ou influência que sabota seu progresso repetidamente.",
        link: "https://wa.me/p/25529082140094227/5521996102492",
      },
      {
        name: "MAPEAMENTO GERAL",
        price: 360,
        description:
          "O Plano de Batalha para 6 meses. Uma análise sistêmica de todas as áreas (financeira, afetiva, saúde). Entenda como uma área drena a outra e saia com um mapa estratégico completo.",
